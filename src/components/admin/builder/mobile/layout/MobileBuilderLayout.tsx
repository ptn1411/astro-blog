...
import { MobileBlockList } from '../panels/MobileBlockList';
...
const MobileWidgetPicker = lazy(() => import('../panels/MobileWidgetPicker').then(m => ({ default: m.MobileWidgetPicker })));
const MobilePropertiesPanel = lazy(() => import('../panels/MobilePropertiesPanel').then(m => ({ default: m.MobilePropertiesPanel })));
const MobilePreviewModal = lazy(() => import('../modals/MobilePreviewModal').then(m => ({ default: m.MobilePreviewModal })));
const MobileSaveModal = lazy(() => import('../modals/MobileSaveModal').then(m => ({ default: m.MobileSaveModal })));
const MobileAIPromptModal = lazy(() => import('../modals/MobileAIPromptModal').then(m => ({ default: m.MobileAIPromptModal })));
const MobilePasteJSONModal = lazy(() => import('../modals/MobilePasteJSONModal').then(m => ({ default: m.MobilePasteJSONModal })));
