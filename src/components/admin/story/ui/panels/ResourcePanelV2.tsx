...
import { StoryImagePicker } from '../pickers/StoryMediaPicker';
...
const DEMO_TEMPLATES: StoryTemplate[] = [
          ...
          elements: [
            {
              ...
              animation: {
                enter: { type: 'fadeIn', duration: 400, delay: 0, easing: 'ease-out' },
              },
            },
            {
              id: 'tpl-el-1',
              type: 'text',
              content: 'BẢN TIN NHANH',
              style: {
                x: 30,
                y: 70,
                width: 300,
              ...
              animation: {
                enter: { type: 'fadeInDown', duration: 700, delay: 0, easing: 'ease-out' },
              },
            },
            {
              id: 'tpl-el-2',
              type: 'text',
              content: '3 điểm nổi bật trong 60 giây',
              style: {
                x: 30,
                y: 140,
                width: 300,
              ...
              animation: {
                enter: { type: 'fadeInUp', duration: 650, delay: 150, easing: 'ease-out' },
              },
            },
            {
              id: 'tpl-el-3',
              ...
              animation: {
                enter: { type: 'fadeIn', duration: 500, delay: 500, easing: 'ease-out' },
                loop: { type: 'pulse', duration: 1400, delay: 0, easing: 'ease-in-out' },
              },
            },
          ],
        },
          ...
          elements: [
            {
              ...
              animation: {
                enter: { type: 'slideInLeft', duration: 650, delay: 0, easing: 'ease-out' },
              },
            },
            {
              id: 'tpl-el-5',
              ...
              animation: {
                enter: { type: 'slideInLeft', duration: 650, delay: 150, easing: 'ease-out' },
              },
            },
            {
              id: 'tpl-el-6',
              ...
              animation: {
                enter: { type: 'slideInLeft', duration: 650, delay: 300, easing: 'ease-out' },
              },
            },
            {
              id: 'tpl-el-7',
              type: 'text',
              content: 'Tóm tắt: cập nhật nhanh, dễ đọc',
              style: {
                x: 24,
                y: 520,
                width: 312,
              ...
              animation: {
                enter: { type: 'zoomIn', duration: 700, delay: 250, easing: 'ease-out' },
                loop: { type: 'pulse', duration: 1600, delay: 0, easing: 'ease-in-out' },
              },
            },
          ],
        },
          ...
          elements: [
            {
              ...
              animation: {
                enter: { type: 'zoomIn', duration: 700, delay: 0, easing: 'ease-out' },
              },
            },
            {
              id: 'tpl-el-9',
              type: 'text',
              content: 'Kết luận / CTA',
              style: {
                x: 24,
                y: 360,
                width: 312,
            ...
            },
            {
              id: 'tpl-el-10',
              type: 'text',
              content: 'Follow để xem phần tiếp theo',
              style: {
                x: 80,
                y: 520,
                width: 200,
              ...
              animation: {
                enter: { type: 'scaleIn', duration: 500, delay: 300, easing: 'spring' },
                loop: { type: 'bounce', duration: 2000, delay: 500, easing: 'ease-in-out' },
              },
            },
          ],
  ...
  {
    id: 'template-12',
    name: 'Cinematic Photo (Image + Motion)',
    category: 'Social',
    thumbnail: '',
    story: {
      slides: [
          ...
          elements: [
            {
              ...
              animation: {
                enter: { type: 'zoomIn', duration: 800, delay: 0, easing: 'ease-out' },
                loop: { type: 'float', duration: 2200, delay: 0, easing: 'ease-in-out' },
              },
            },
            {
              id: 'tpl-el-2',
              type: 'text',
              content: 'CINEMATIC MOOD',
              style: {
                x: 30,
                y: 520,
                width: 300,
              ...
              animation: {
                enter: { type: 'fadeInUp', duration: 650, delay: 200, easing: 'ease-out' },
              },
            },
            {
              id: 'tpl-el-3',
              ...
              animation: {
                enter: { type: 'fadeIn', duration: 500, delay: 450, easing: 'ease-out' },
              },
            },
          ],
        },
      ...
      slides: [
        {
          ...
          transition: { type: 'flip', duration: 750 },
          elements: [
            {
              id: 'tpl-el-1',
              type: 'text',
              ...
              animation: {
                enter: { type: 'rotateIn', duration: 800, delay: 0, easing: 'ease-out' },
              },
            },
            {
              id: 'tpl-el-2',
              ...
              animation: {
                enter: { type: 'fadeIn', duration: 600, delay: 150, easing: 'ease-out' },
              },
            },
            {
              id: 'tpl-el-3',
              type: 'countdown',
              content: '',
              countdown: { targetDate: '2026-01-01T00:00:00.000Z', label: 'Đếm ngược' },
              style: {
                x: 30,
                y: 300,
                width: 300,
              ...
              animation: {
                enter: { type: 'scaleIn', duration: 650, delay: 250, easing: 'spring' },
              },
            },
            {
              id: 'tpl-el-4',
              type: 'text',
              content: 'Nhấn để nhận thông báo',
              style: {
                x: 80,
                y: 520,
                width: 200,
              ...
              animation: {
                enter: { type: 'fadeInUp', duration: 650, delay: 350, easing: 'ease-out' },
                loop: { type: 'pulse', duration: 1400, delay: 0, easing: 'ease-in-out' },
              },
            },
          ],
